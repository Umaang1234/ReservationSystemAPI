...
CREATE TABLE `via_details` (
  ...
  `via_station_code` varchar(45) NOT NULL,
  `km_from_origin` double DEFAULT NULL,
  `reach-time` time DEFAULT NULL,
  PRIMARY KEY (`Details_id`),
  KEY `TrainCode_idx` (`Train_code`),
  CONSTRAINT `TrainCode` FOREIGN KEY (`Train_code`) REFERENCES `train` (`Train_code`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2023-07-02 22:51:17
