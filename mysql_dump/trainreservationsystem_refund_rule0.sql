...
CREATE TABLE `refund_rule` (
  `to-time` time DEFAULT NULL,
  `from-time` time DEFAULT NULL,
  `Refundable-Amt` double DEFAULT NULL,
  `PassengerId` int NOT NULL AUTO_INCREMENT,
  KEY `Passenger_Id_idx` (`PassengerId`),
  CONSTRAINT `pass_Id` FOREIGN KEY (`PassengerId`) REFERENCES `pax_info` (`Passenger_id`) ON UPDATE CASCADE
...
-- Dump completed on 2023-07-02 22:51:15
