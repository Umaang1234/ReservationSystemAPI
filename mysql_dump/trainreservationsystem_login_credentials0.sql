...
CREATE TABLE `login_credentials` (
  ...
  CONSTRAINT `Passenger_Id` FOREIGN KEY (`Passenger_Id`) REFERENCES `pax_info` (`Passenger_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `login_credentials` VALUES (1,'qwerty',1);
